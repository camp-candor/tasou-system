...
export const initDatum = (cpy: DatumModel, bal: DatumBit, ste: State) => {
    debugger
    return cpy;
};

export const openDatum = async (cpy: DatumModel, bal: DatumBit, ste: State) => {
...
export const updateDatum = async (cpy: DatumModel, bal: DatumBit, ste: State) => {

    bal.slv({ datBit: { idx: "update-datum" } });
    return cpy;
};

export const createDatum = async (cpy: DatumModel, bal: DatumBit, ste: State) => {
...
export const readDatum = async (cpy: DatumModel, bal: DatumBit, ste: State) => {
...
export const writeDatum = async (cpy: DatumModel, bal: DatumBit, ste: State) => {
...
export const removeDatum = async (cpy: DatumModel, bal: DatumBit, ste: State) => {
...
export const deleteDatum = (cpy: DatumModel, bal: DatumBit, ste: State) => {

    bal.slv({ datBit: { idx: "delete-datum" } });
    return cpy;
};

export const listDatum = async (cpy: DatumModel, bal: DatumBit, ste: State) => {
