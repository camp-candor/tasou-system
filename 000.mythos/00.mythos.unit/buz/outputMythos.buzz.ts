...
export const outputMythos = async (cpy: MythosModel, bal: MythosBit, ste: State) => {
  ...
  if (typeof document === 'undefined') return bal.slv({ ctlBit: { idx: "output-mythos", src: 'no document', dat: output } });
  if (document === undefined) return bal.slv({ ctlBit: { idx: "output-mythos", src: 'no document', dat: output } });
  ...
  bal.slv({ ctlBit: { idx: "output-mythos", dat: output } });
